					...
					<section id="one" class="main">
						<ul class="tabs">
							...
							<li>
								<h3>診所介紹</h3>
								<div class="spotlight">
									<img id="clinicPic" src="img/clinic.jpg">
									<div id="clinicInfo">
										<p class="clinicName">診所中文名稱</p>
										<p class="clinicIntro">診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介診所簡介</p>
									</div>
								</div>
							</li>
						</ul>
...
<!-- Scripts -->
	<script src="templates/px-hypothesis-html/blue/assets/js/jquery.min.js"></script>
	<script src="templates/px-hypothesis-html/blue/assets/js/jquery.dropotron.min.js"></script>
	<script src="templates/px-hypothesis-html/blue/assets/js/jquery.selectorr.min.js"></script>
	<script src="templates/px-hypothesis-html/blue/assets/js/jquery.scrollex.min.js"></script>
	<script src="templates/px-hypothesis-html/blue/assets/js/jquery.scrolly.min.js"></script>
	<script src="templates/px-hypothesis-html/blue/assets/js/skel.min.js"></script>
	<script src="templates/px-hypothesis-html/blue/assets/js/util.js"></script>
	<script src="templates/px-hypothesis-html/blue/assets/js/main.js"></script>
