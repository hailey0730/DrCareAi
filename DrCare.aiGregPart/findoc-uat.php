...
<head>
  ...
  (function(d, s, id){
    ...
    <script src="js/findoc-uat.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/searchHealthArticle.css" />

    <link rel="stylesheet" type="text/css" href="css/general.css" />
    <!-- <link rel="stylesheet" type="text/css" href="../assets/css/headerFooter.css" /> --> <!-- unable to use the main one -->
    <link rel="stylesheet" type="text/css" href="css/header_footer.css" />
    <link rel="stylesheet" type="text/css" href="css/findoc-uat.css" />
