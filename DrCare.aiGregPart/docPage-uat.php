<?php
	...
	$url = $url."&Doctor=".urlencode($docName);
	$json = file_get_contents($url);
	$results = json_decode($json, true);

	$essay1 = $results[0]["Subject"];
	$essay2 = $results[1]["Subject"];
	$essay3 = $results[2]["Subject"];
...
<head>
  ...
  (function(d, s, id){
    ...
    <title><? echo $fullName." ".$subcat; ?> | DrCare.ai</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/docPage-uat.css" />
...
<div class="mainContainer">
	...
	<div class="infoContainer">
		...
		<p id="viewinfo">
			...
			<span class="commonText" id="commonText1"></span>
			<span id="viewtype"></span>
			<span class="commonText" id="commonText2"></span>
		...
		<div class="infoDiv">
			...
			<div class="basicInfo">
				<div class="basicInfoText">
					...
					<p id="docGender" style="display: inline-block;">性別：<span></span></p>
						...
						<!-- <div class="infinitePanel" id="docQA">
							<div class="spotlight">
								<div class="docAnswers">
									<div class="total">
										<p class="grey"> XXX醫生共有</p><p class="blue"></p><p class="grey" >問答</p>
									</div>
									<div class="QAContent">
